...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ksab..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 979724285 then
var =  'مالك السورس'
elseif  UserID == 1153357069 then
var =  'SOURCE DEV'
elseif  UserID == 1588236583 then
var =  'مطور السورس'
elseif  UserID == 1074128626 then
var =  'مالك السورس'
elseif  UserID == 1244873483 then
var =  'مطور  السورس'
elseif  UserID == 01147767929 then
var =  'مطور  السورس'
elseif redis:sismember(ksab..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(ksab..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(ksab..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(ksab..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(ksab..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(ksab..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(ksab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(ksab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(ksab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(ksab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(ksab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(ksab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(ksab..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(ksab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(ksab..':SUDO_BOT:')
message = '⌯ ** قائمه الـمـطـوريـن : \n\n`⌯ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(ksab..'username:'..v)
local count = redis:scard(ksab..'mtwr_count'..v)
...
local monsha = redis:smembers(ksab..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⌯ قائمه المدراء :*\n\n'
local list = redis:smembers(ksab..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(ksab..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ksab..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ksab..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ksab..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ksab..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(ksab..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(ksab..'gban_users')
...
local list = redis:smembers(ksab..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ksab..':Filter_Word:'..msg.chat_id_,word) then 
return  "⌯ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(ksab..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(ksab..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(ksab..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(ksab..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(ksab..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(ksab..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(ksab..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(ksab..'group:ids')
message = '⌯ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(ksab..'group:name'..v)
if info then 
...
redis:del(
ksab..'group:add'..id_group,
ksab..'lock_link'..id_group, 
ksab..'lock_id'..id_group,
ksab..'lock_spam'..id_group, 
ksab..'lock_webpage'..id_group,
ksab..'lock_markdown'..id_group,
ksab..'lock_flood'..id_group,
ksab..'lock_bots'..id_group,
ksab..'mute_forward'..id_group,
ksab..'mute_contact'..id_group,
ksab..'mute_location'..id_group,
ksab..'mute_document'..id_group,
ksab..'mute_keyboard'..id_group,
ksab..'mute_game'..id_group,
ksab..'mute_inline'..id_group,
ksab..'lock_username'..id_group,
ksab..'num_msg_ksab'..id_group,
ksab..'replay'..id_group
)
redis:srem(ksab..'group:ids',id_group)
end
...
redis:hset(ksab..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(ksab..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(ksab..'group:add'..msg.chat_id_) then  return '⌯ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(ksab..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(ksab..':addnumberusers') or 0)
...
local lock_service = redis:get(ksab..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ksab..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(ksab..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
ksab..'group:add'..msg.chat_id_,true,
ksab..'lock_link'..msg.chat_id_,true, 
ksab..'lock_id'..msg.chat_id_,true,
ksab..'lock_spam'..msg.chat_id_,true,
ksab..'lock_webpage'..msg.chat_id_,true,
ksab..'lock_markdown'..msg.chat_id_,true,
ksab..'lock_flood'..msg.chat_id_,true,
ksab..'lock_bots'..msg.chat_id_,true,
ksab..'mute_forward'..msg.chat_id_,true,
ksab..'mute_contact'..msg.chat_id_,true,
ksab..'mute_location'..msg.chat_id_,true,
ksab..'mute_document'..msg.chat_id_,true,
ksab..'mute_keyboard'..msg.chat_id_,true,
ksab..'mute_game'..msg.chat_id_,true,
ksab..'mute_inline'..msg.chat_id_,true,
ksab..'lock_username'..msg.chat_id_,true,
ksab..'num_msg_ksab'..msg.chat_id_,5, 
ksab..'replay'..msg.chat_id_,true
)

redis:sadd(ksab..'group:ids',msg.chat_id_) 
redis:sadd(ksab..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(ksab..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(ksab..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(ksab..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(ksab..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID,'username',Resolv)
redis:sadd(ksab..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(ksab..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(ksab..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ksab..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID,'username',Resolv)
redis:sadd(ksab..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(ksab..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(ksab..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(ksab..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(ksab..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(ksab..'whitelist:'..ChatID,UserID)
...
if redis:sismember(ksab..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..'owners:'..ChatID,UserID)
...
if redis:sismember(ksab..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(ksab..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(ksab..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(ksab..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(ksab..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(ksab..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(ksab..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(ksab..'banned:'..ChatID,UserID)
...
if redis:sismember(ksab..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(ksab..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(ksab..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(ksab..'username:'..UserID, 'username',Resolv)
redis:sadd(ksab..'gban_users',UserID)
...
redis:srem(ksab..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(ksab..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(ksab..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(ksab..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(ksab..'username:'..UserID, 'username', UserName)
redis:sadd(ksab..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ksab..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⌯ **العضو » ❪ '..UserName..' ❫\n⌯ **الايدي » ❪ `'..UserID..'` ❫\n⌯ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(ksab..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(ksab..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(ksab..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(ksab..'username:'..UserID, 'username', Resolv)
redis:sadd(ksab..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(ksab..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(ksab..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⌯ **العضو » '..USERNAME..' \n⌯ ** الايدي » (`'..UserID..'`)\n⌯ **انه بالتأكيد ليس مطور \n') end
redis:srem(ksab..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⌯ العضو » ❪ '..USERNAME..' ❫\n⌯ الايدي » ❪ '..UserID..' ❫\n⌯ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(ksab..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(ksab..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(ksab..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(ksab..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⌯*` اعدادات المجموعه :` \n"
.."\n⌯ التعديل «» "..(redis:get(ksab..'lock_edit'..msg.chat_id_) or 'false')
.."\n⌯ الروابط «» "..(redis:get(ksab..'lock_link'..msg.chat_id_) or 'false')
.."\n⌯ التاك «» "..(redis:get(ksab..'lock_tag'..msg.chat_id_) or 'false')
.."\n⌯ المعرفات «» "..(redis:get(ksab..'lock_username'..msg.chat_id_) or 'false')
.."\n⌯ التكرار «» "..(redis:get(ksab..'lock_flood'..msg.chat_id_) or 'false')
.."\n⌯ الكلايش «» "..(redis:get(ksab..'lock_spam'..msg.chat_id_) or 'false')
.."\n⌯ الويب «» "..(redis:get(ksab..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⌯ الماركدوان «» "..(redis:get(ksab..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⌯ بالطرد البوتات «» "..(redis:get(ksab..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⌯ البوتات «» "..(redis:get(ksab..'lock_bots'..msg.chat_id_) or 'false')
.."\n⌯ عدد التكرار «» "..(redis:get(ksab..'num_msg_ksab'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⌯`اعدادات الوسائط :`\n"
.."\n*⌯ *المتحركه «» "..(redis:get(ksab..'mute_gif'..msg.chat_id_) or 'false')
.."\n⌯ الدردشه «» "..(redis:get(ksab..'mute_text'..msg.chat_id_) or 'false')
.."\n⌯ الانلاين «» "..(redis:get(ksab..'mute_inline'..msg.chat_id_) or 'false')
.."\n⌯ الالعاب «» "..(redis:get(ksab..'mute_game'..msg.chat_id_) or 'false')
.."\n⌯ الصور «» "..(redis:get(ksab..'mute_photo'..msg.chat_id_) or 'false')
.."\n⌯ الفيديو «» "..(redis:get(ksab..'mute_video'..msg.chat_id_) or 'false')
.."\n⌯ البصمات «» "..(redis:get(ksab..'mute_audio'..msg.chat_id_) or 'false')
.."\n⌯ الصوت «» "..(redis:get(ksab..'mute_voice'..msg.chat_id_) or 'false')
.."\n⌯ الملصقات «» "..(redis:get(ksab..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⌯ الجهات «» "..(redis:get(ksab..'mute_contact'..msg.chat_id_) or 'false')
.."\n⌯ التوجيه «» "..(redis:get(ksab..'mute_forward'..msg.chat_id_) or 'false')
.."\n⌯ الموقع «» "..(redis:get(ksab..'mute_location'..msg.chat_id_) or 'false')
.."\n⌯ الملفات «» "..(redis:get(ksab..'mute_document'..msg.chat_id_) or 'false')
.."\n⌯ الاشعارات «» "..(redis:get(ksab..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⌯ الكيبورد «» "..(redis:get(ksab..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⌯*`اعدادات اخرى : `"
.."\n\n*⌯*الترحيب «» "..welcomex
.."\n*⌯*الردود «» "..replayx
...
.."\n*⌯*الويب «» "..(redis:get(ksab..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⌯*الماركدوان «» "..(redis:get(ksab..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⌯*البوتات بالطرد «» "..(redis:get(ksab..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⌯*البوتات «» "..(redis:get(ksab..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⌯*عدد التكرار «» "..(redis:get(ksab..'num_msg_ksab'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⌯*اعدادات التقـييد :\n"
.."\n*⌯*التقييد بالتوجيه «» "..(redis:get(ksab..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⌯*التقييد بالصور «» "..(redis:get(ksab..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⌯*التقييد بالروابط «» "..(redis:get(ksab..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⌯*التقييد بالمتحركه «» "..(redis:get(ksab..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⌯*التقييد الفيديو «» "..(redis:get(ksab..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
