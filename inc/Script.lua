...
redis:set(ksab.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(ksab..'lock:join:'..msg.chat_id_,true)
...
redis:del(ksab..'lock:join:'..msg.chat_id_)
return "*⌯ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n⌯ ** تم فتح الدخول بالرابط \n*" 
end


local function iksab(msg,MsgText)

Channel = redis:get(ksab..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(ksab..'joinchnl') then
...
redis:setex(ksab..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(ksab..'CheckExpire::'..msg.chat_id_) then 
redis:set(ksab..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(ksab..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(ksab..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(ksab..'CheckExpire::'..msg.chat_id_) then 
redis:set(ksab..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(ksab..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(ksab..'CheckExpire::'..msg.chat_id_) then 
redis:set(ksab..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(ksab..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(ksab..'CheckExpire::'..msg.chat_id_) then 
redis:set(ksab..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(ksab..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(ksab..'group:name'..msg.chat_id_) or '')
redis:set(ksab..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(ksab..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. ksab..'')
...
if not msg.Director and redis:get(ksab..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(ksab..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(ksab..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(ksab..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(ksab..'admins:'..msg.chat_id_)
redis:del(ksab..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(ksab..'owners:'..msg.chat_id_)
redis:del(ksab..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(ksab..'whitelist:'..msg.chat_id_)
redis:del(ksab..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(ksab..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(ksab..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(ksab..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(ksab..'linkGroup'..msg.sender_user_id_,300,true)
return '⌯ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(ksab..'linkGroup'..msg.chat_id_) then 
return "⌯ ** اوه لا يوجد رابط .\n⌯ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(ksab..'group:name'..msg.chat_id_)
local GroupLink = redis:get(ksab..'linkGroup'..msg.chat_id_)
...
local Text = "⌯ رابـط الـمـجـمـوعه ⌯ \n"..Flter_Markdown(redis:get(ksab..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(ksab..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(ksab..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "⌯ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(ksab..':Filter_Word:'..msg.chat_id_)
...
redis:del(ksab..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(ksab..'welcome:msg'..msg.chat_id_) then 
return "⌯ ** اوه هنالك خطأ .\n⌯ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(ksab..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(ksab..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⌯ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(ksab..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "⌯ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(ksab..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⌯ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(ksab..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(ksab..'banned:'..msg.chat_id_)
if #list == 0 then return "*⌯ لا يوجد مستخدمين محظورين  *" end
message = '⌯ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(ksab..'banned:'..msg.chat_id_)
return "⌯ **أهلا عزيزي "..msg.TheRankCmd.."   \n⌯  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(ksab..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "⌯ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(ksab..'is_silent_users:'..msg.chat_id_)
...
redis:del(ksab..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "⌯ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(ksab..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(ksab..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "⌯ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(ksab..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(ksab..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(ksab..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(ksab..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(ksab..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(ksab..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(ksab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(ksab..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(ksab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(ksab.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(ksab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(ksab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(ksab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(ksab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(ksab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(ksab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(ksab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(ksab..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(ksab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "⌯ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '⌯ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⌯ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(ksab..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "⌯ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(ksab..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(ksab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(ksab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(ksab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(ksab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(ksab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(ksab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(ksab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(ksab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(ksab..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(ksab..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(ksab..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(ksab..'welcome:msg'..msg.chat_id_))
else 
return "⌯ **أهلا عزيزي "..msg.TheRankCmd.."  \n⌯ نورت المجموعه \n" 
end 
end
...
redis:setex(ksab..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(ksab..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⌯ اهلا انا بوت]]..redis:get(ksab..':NameBot:')..[[ .
...
redis:setex(ksab..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '⌯ حسننا عزيزي .\n⌯ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(ksab..':addnumberusers',MsgText[2]) 
return '⌯ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'⌯ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(ksab..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "⌯ **هذا الامر يخص {المطور} فقط  \n" end
return '⌯ ** عدد المجموعات المفعلة » `'..redis:scard(ksab..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "⌯ **هذا الامر يخص {المطور} فقط  \n" end
return '⌯ **عدد المشتركين في البوت : `'..redis:scard(ksab..'users')..'` \n'
end
...
if not msg.SudoUser then return "⌯ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(ksab..'group:ids',MsgText[2]) then
local name_gp = redis:get(ksab..'group:name'..MsgText[2])
...
return redis:get(ksab..":TEXT_SUDO") or '⌯ لا توجد كليشه المطور .\n⌯ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"⌯ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(ksab..'lock_brod') then 
return "⌯ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(ksab..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(ksab..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(ksab..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(ksab..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(ksab..'welcom:witting'..msg.sender_user_id_,
ksab..'rulse:witting'..msg.sender_user_id_,
ksab..'rulse:witting'..msg.sender_user_id_,
ksab..'name:witting'..msg.sender_user_id_,
ksab..'about:witting'..msg.sender_user_id_,
ksab..'fwd:all'..msg.sender_user_id_,
ksab..'fwd:pv'..msg.sender_user_id_,
ksab..'fwd:groups'..msg.sender_user_id_,
ksab..'namebot:witting'..msg.sender_user_id_,
ksab..'addrd_all:'..msg.sender_user_id_,
ksab..'delrd:'..msg.sender_user_id_,
ksab..'addrd:'..msg.sender_user_id_,
ksab..'delrdall:'..msg.sender_user_id_,
ksab..'text_sudo:witting'..msg.sender_user_id_,
ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_,
ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamedadel-dev/ksabFILE/main/GetVersion.txt' ) or 0
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/K_AsA_B"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : كساب](https://t.me/K_AsA_B)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '⌯ الاحصائيات . \n\n⌯ **عدد المجموعات المفعله : '..redis:scard(ksab..'group:ids')..'\n⌯ **عدد المشتركين في البوت : '..redis:scard(ksab..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(ksab..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(ksab..'replay:'..msg.chat_id_)
local photo 	= redis:exists(ksab..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(ksab..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(ksab..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(ksab..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(ksab..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(ksab..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(ksab..'replay:'..msg.chat_id_,ksab..'replay_photo:group:'..msg.chat_id_,ksab..'replay_voice:group:'..msg.chat_id_,
ksab..'replay_animation:group:'..msg.chat_id_,ksab..'replay_audio:group:'..msg.chat_id_,ksab..'replay_sticker:group:'..msg.chat_id_,ksab..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(ksab..'replay:all')
local photo 	= redis:exists(ksab..'replay_photo:group:')
local voice 	= redis:exists(ksab..'replay_voice:group:')
local imation 	= redis:exists(ksab..'replay_animation:group:')
local audio 	= redis:exists(ksab..'replay_audio:group:')
local sticker 	= redis:exists(ksab..'replay_sticker:group:')
local video 	= redis:exists(ksab..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(ksab..'replay:all',ksab..'replay_photo:group:',ksab..'replay_voice:group:',ksab..'replay_animation:group:',ksab..'replay_audio:group:',ksab..'replay_sticker:group:',ksab..'replay_video:group:')
...
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(ksab..'delrdall:'..msg.sender_user_id_,true) 
return "⌯ حسننا عزيزي  .\n⌯ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(ksab..'delrd:'..msg.sender_user_id_,true)
return "⌯ حسننا عزيزي  .\n⌯ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "⌯ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(ksab..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(ksab..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(ksab..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(ksab..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(ksab..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(ksab..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(ksab..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(ksab..'replay:all')
local photo 	= redis:hkeys(ksab..'replay_photo:group:')
local voice 	= redis:hkeys(ksab..'replay_voice:group:')
local imation 	= redis:hkeys(ksab..'replay_animation:group:')
local audio 	= redis:hkeys(ksab..'replay_audio:group:')
local sticker 	= redis:hkeys(ksab..'replay_sticker:group:')
local video 	= redis:hkeys(ksab..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '⌯ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "⌯ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(ksab..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "⌯ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(ksab..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n⌯ " end
if not redis:get(ksab..'lave_me'..msg.chat_id_) then 
return "⌯ **أهلا عزيزي "..msg.TheRankCmd.."\n⌯ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(ksab..'lave_me'..msg.chat_id_) 
return "⌯ **أهلا عزيزي "..msg.TheRankCmd.."\n⌯ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "⌯ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n⌯ " end
if redis:get(ksab..'lave_me'..msg.chat_id_) then 
return "⌯ **أهلا عزيزي "..msg.TheRankCmd.."\n⌯ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(ksab..'lave_me'..msg.chat_id_,true)  
...
•𝒅𝒆𝒗² >> [ 𝒅𝒆𝒗𝒊𝒍 𖤍 ](t.me/lllDEVILlll)
•𝒄𝒉 >> [• 𝐒𝐎𝗨𝐑𝐂𝐄 𝐊𝐀𝐒𝐀𝐁 & 𝘿𝙚𝙫𝙞𝙡 .](t.me/K_AsA_B)
...
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(ksab..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"⌯ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(ksab..":UserNameChaneel")
if UserChaneel then
...
if redis:get(ksab..'welc'..msg.chat_id_) == 'on' then
...
local hash = ksab..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(ksab..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(ksab..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(ksab..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'⌯ اهلا عزيزي \n⌯ تم تثبيت الامر الجديد\n✓')
redis:del(ksab..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "⌯ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(ksab..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(ksab..'CmD:'..msg.chat_id_,cmd)
redis:srem(ksab..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"⌯ اهلا عزيزي\nالامر >"..cmd.."\n⌯ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "⌯ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(ksab..'CmD:'..msg.chat_id_)
redis:del(ksab..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"⌯ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "⌯ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(ksab..'CmDlist:'..msg.chat_id_)
local t = '⌯ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(ksab..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(ksab..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(ksab..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(ksab..'welc'..msg.chat_id_,'off')
redis:del(ksab..'welc'..msg.chat_id_,'on')
else
...
local msg_pv = tonumber(redis:get(ksab..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(ksab..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*⌯ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(ksab..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس كساب\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(ksab..'users',msg.sender_user_id_)
if redis:get(ksab..'lock_service') then 
text = [[⌯ أهلاً انا بوت   []]..redis:get(ksab..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(ksab.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(ksab..'lock_twasel') then
...
redis:setex(ksab.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ksab..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ksab..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(ksab..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n⌯ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(ksab..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه صوره للرد بنجاح\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(ksab..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه بصمه صوت للرد بنجاح\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(ksab..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه متحركه للرد بنجاح\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(ksab..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه فيديو للرد بنجاح\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(ksab..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه للصوت للرد بنجاح\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(ksab..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(ksab..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(ksab..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(ksab..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ⌯ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(ksab..'replay_photo:group:',klma,photo_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه صوره للرد العام\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(ksab..'replay_voice:group:',klma,voice_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه بصمه صوت للرد العام\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(ksab..'replay_animation:group:',klma,animation_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه متحركه للرد العام\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(ksab..'replay_video:group:',klma,video_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه فيديو للرد العام\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(ksab..'replay_audio:group:',klma,audio_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم اضافه للصوت للرد العام\n⌯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(ksab..'replay_sticker:group:',klma,sticker_id)
redis:del(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(ksab..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(ksab..":ForceSub:"..msg.sender_user_id_)
...
redis:set(ksab..":UserNameChaneel",msg.text)
...
if redis:get(ksab..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(ksab..'namebot:witting'..msg.sender_user_id_)
redis:set(ksab..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"⌯ تم تغير اسم البوت  .\n⌯ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(ksab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(ksab..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(ksab..'replay_photo:group:',msg.text)
redis:hdel(ksab..'replay_voice:group:',msg.text)
redis:hdel(ksab..'replay_animation:group:',msg.text)
redis:hdel(ksab..'replay_audio:group:',msg.text)
redis:hdel(ksab..'replay_sticker:group:',msg.text)
redis:hdel(ksab..'replay_video:group:',msg.text)
redis:setex(ksab..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⌯ جيد , يمكنك الان ارسال جوا ب الردالعام \n⌯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(ksab..'delrdall:'..msg.sender_user_id_) then
redis:del(ksab..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(ksab..'replay:all',msg.text)
local photo =redis:hget(ksab..'replay_photo:group:',msg.text)
local voice = redis:hget(ksab..'replay_voice:group:',msg.text)
local animation = redis:hget(ksab..'replay_animation:group:',msg.text)
local audio = redis:hget(ksab..'replay_audio:group:',msg.text)
local sticker = redis:hget(ksab..'replay_sticker:group:',msg.text)
local video = redis:hget(ksab..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⌯ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(ksab..'replay:all',msg.text)
redis:hdel(ksab..'replay_photo:group:',msg.text)
redis:hdel(ksab..'replay_voice:group:',msg.text)
redis:hdel(ksab..'replay_audio:group:',msg.text)
redis:hdel(ksab..'replay_animation:group:',msg.text)
...
if redis:get(ksab..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(ksab..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(ksab..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "⌯ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(ksab..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(ksab..'welcom:witting'..msg.sender_user_id_) 
redis:set(ksab..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⌯ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(ksab..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(ksab..'rulse:witting'..msg.sender_user_id_) 
redis:set(ksab..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⌯ ** مرحبآ عزيزي\n⌯ تم حفظ القوانين بنجاح .\n⌯ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(ksab..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(ksab..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(ksab..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(ksab..'linkGroup'..msg.sender_user_id_,link) 
redis:set(ksab..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(ksab..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(ksab..'about:witting'..msg.sender_user_id_) 
...
if redis:get(ksab..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(ksab..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(ksab..'users')  
local groups = redis:smembers(ksab..'group:ids')
...
if redis:get(ksab..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ksab..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(ksab..'users')
if #pv >= 300 then
...
if redis:get(ksab..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(ksab..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(ksab..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(ksab..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(ksab..':WELCOME_BOT'),[[•أهلاً انا بوت ]]..redis:get(ksab..':NameBot:')..[[
⌯ أختصاصي حماية‌‏ المجموعات
⌯ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(ksab..'fwd:'..msg.sender_user_id_) then
redis:del(ksab..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(ksab..'users')
local groups = redis:smembers(ksab..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(ksab..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(ksab..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(ksab..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'⌯ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(ksab..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(ksab..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(ksab..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(ksab..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(ksab..'replay:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(ksab..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(ksab..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"⌯ جيد , يمكنك الان ارسال جواب الرد \n⌯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(ksab..'delrd:'..msg.sender_user_id_) then
redis:del(ksab..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(ksab..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(ksab..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(ksab..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(ksab..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(ksab..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(ksab..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(ksab..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'⌯ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(ksab..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(ksab..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(ksab..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(ksab..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(ksab..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(ksab..'welcome:msg'..msg.chat_id_) or "⌯ اهلاً عزيزي {الاسم}\n⌯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⌯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(ksab..'rulse:msg'..msg.chat_id_) or "⌯ مرحباً عزيري القوانين كلاتي .\n⌯ ممنوع نشر الروابط\n⌯ ممنوع التكلم او نشر صور اباحيه\n⌯ ممنوع  اعاده توجيه\n⌯ ممنوع التكلم بالسياسة\n⌯ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(ksab..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(ksab..'welcome:msg'..msg.chat_id_) or "⌯ اهلن بك عزيزي {الاسم}\n⌯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⌯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(ksab..'rulse:msg'..msg.chat_id_) or "⌯ مرحباً عزيري القوانين كلاتي .\n⌯ ممنوع نشر الروابط\n⌯ ممنوع التكلم او نشر صور اباحيه\n⌯ ممنوع  اعاده توجيه\n⌯ ممنوع التكلم بالسياسة\n⌯ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(ksab..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(ksab..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(ksab..'welcome:get'..msg.chat_id_)
end
redis:setex(ksab..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(ksab..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(ksab..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_ksab = (redis:get(ksab..'num_msg_ksab'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_ksab) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(ksab..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"⌯ العضو » "..USERNAME.."\n⌯ قمـت بتكرار اكثر مـن "..NUM_MSG_ksab.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(ksab..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(ksab..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(ksab..'lock_woring'..msg.chat_id_) and not redis:get(ksab..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(ksab..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(ksab..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(ksab..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'⌯ ** لا يمكنني مسح الرساله المخالفه .\n⌯ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(ksab..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(ksab..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ksab..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ksab..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(ksab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(ksab..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(ksab..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(ksab..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(ksab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(ksab..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(ksab..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(ksab..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ksab..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(ksab..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ksab..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(ksab..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(ksab..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(ksab..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(ksab..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(ksab..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(ksab..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(ksab..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(ksab..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(ksab..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(ksab..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(ksab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(ksab..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(ksab..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(ksab..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(ksab..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(ksab..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ksab..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(ksab..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(ksab..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(ksab..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "سونيك" or Text== "محمود ابوالمجد" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/UU_IV)")
elseif Text== "محمد الرفاعي" or Text== "كساب" then return  sendMsg(msg.chat_id_,msg.id_,"[مالك السورس](https://t.me/X_M_Dodda)")
elseif Text== "الديفل" or Text== "ديفل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/lllDEVILlll)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/K_AsA_B) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/K_AsA_B)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/K_AsA_B)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/K_AsA_B)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/K_AsA_B)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/K_AsA_B) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/K_AsA_B)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/K_AsA_B)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/K_AsA_B)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/K_AsA_B)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..ksab..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(ksab..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(ksab..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(ksab..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(ksab..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(ksab..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(ksab..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(ksab..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(ksab..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(ksab..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'⌯ انتهى الاشتراك في احد المجموعات .\n⌯ المجموعه : '..FlterName(redis:get(ksab..'group:name'..msg.chat_id_))..'.\n⌯ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'⌯ انتهى الاشتراك البوت.\n⌯ سوف اغادر المجموعه فرصه سعيده .\n⌯ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(ksab..'ExpireDate:'..msg.chat_id_) / 86400)
