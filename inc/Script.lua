...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamedadel-dev/ksabFILE/master/GetVersion.txt' ) or 0
...
⌯︙ [ مـطـور الـسـورس ](t.me/X_M_Dodda)
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
return sendMsg(msg.chat_id_,msg.id_,"[انت المطور الغالي ♕](https://t.me/K_AsA_B) ")
...
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو ذليل𖦹](https://t.me/K_AsA_B)")
end 
end 
