...
name = katu[math.random(#katu)]
redis:set(ksab..':Set_twet:'..msg.chat_id_,name)
...
return '- اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(ksab..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️- اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(ksab..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(ksab.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(ksab.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(ksab.."GAME:CHER"..msg.chat_id_,'نشط') 
...
redis:set(ksab.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
